      ...
      {AuthenticationService.isUserLoggedIn() ? (
        ...
        {isSuic && (
          <p style={{ marginBottom: "20px" }}>
            If you are, please talk to someone. Call the suicide hotline at the
            number 988, or speak to your doctor immediately.{" "}
          </p>
        )}
        ...
        <p>
          Write about a few things that you are grateful for or that you are
          proud of!
        </p>
